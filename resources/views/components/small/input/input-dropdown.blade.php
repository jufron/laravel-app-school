<div class="mb-4.5 {{ $className ?? null }}">
  <label for="{{ $label }}" class="mb-3 block text-sm font-medium text-black dark:text-white">
    {{ $label }}
  </label>
...
{{--
<x-small.input.input-dropdown
  label="Jenis kelamin"
  name="jenis_kelamin"
  >
  <option value="" class="text-body">USA</option>
  <option value="" class="text-body">UK</option>
  <option value="" class="text-body" selected>Canada</option>
</x-small.input.input-dropdown>
 --}}
