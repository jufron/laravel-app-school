  ...
  <x-slot:content>
    <x-small.navbar />
      ...
      <div class="dark:bg-slate-900">
        <div class="py-3 container md:max-w-3xl mx-auto rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">

          <div class="w-full h-75 bg-gray-200 bg-slate-200 dark:bg-slate-800 mt-4 rounded-md flex items-center justify-center">
